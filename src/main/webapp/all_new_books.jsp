...
<body>
	...
	<c:if test="${not empty addcartobj }">
		<div id="toast">${addcartobj}</div>
	...
	<c:remove var="addcartobj" scope="session"/>
	...
	<div class="container">
		...
		<div class="row">
			...
			List<BookDts> list = dao.getAllNewBooks();
			for (BookDts b : list) {
			%>
			<div class="col-md-3">
				<div class="card crd-ho">
					<div class="card-body text-center">
						...
						<div class="row">
							...
							<% } %>
							 <a
								href="view_details.jsp?bid=<%=b.getBookId()%>"
